...
When you create a volume, it's stored within a directory on the Docker host. When you mount the volume into a container, this directory is what's mounted into the container. This is similar to the way that [Bind mounts](Bind mount) work, except that volumes are managed by Docker and are isolated from the core functionality of the host machine.
